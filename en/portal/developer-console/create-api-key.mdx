...
According to your organization's [governance policies](/en/portal/organization/governance-intro) settings, this request may require approval from a specific number of organization admins in Cobo Guard. You can view the approval rules for registering an API key by clicking your profile avatar in the top-right corner > **Organization** > **Governance Policies** > **Developers**.
