...
Admins and Operators can register API keys on Developer and assign specific user roles, permissions, and IP whitelists.
...
- For Main and Recovery Keys, choose high-ranking executives in your organization as key share holders, preferably with [Viewer](/en/portal/organization/roles-and-permissions) roles to minimize their involvement in daily operations. For Signing Keys, key share holders can be selected from various organizational levels based on operational needs and security considerations.
