...
To make a transfer from Smart Contract Wallets (Safe\{Wallet\}), log in to [Cobo Portal](https://portal.cobo.com/login) and then click **Transfer** in the left sidebar.
