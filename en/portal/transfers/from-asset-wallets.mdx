...
2. To open the **Transfer** dialog, click **Transfer** in the left sidebar. Alternatively, click <img src="/en/images/custodial-wallet/withdraw-icon.png" className="icon"/> on your Asset Wallet page, the corresponding token or address will be preselected for you.
